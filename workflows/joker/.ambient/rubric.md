...
- **1**: Not funny at all, falls completely flat.

## Relevance (Weight: 0.25)
- **5**: Every joke is tightly connected to the given topic.
- **4**: Most jokes are on-topic with minor tangents.
- **3**: About half the jokes relate to the topic.
- **2**: Loosely connected at best, feels like filler.
